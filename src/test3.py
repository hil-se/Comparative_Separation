...
#
r1 = 0.23 #P(C = 1, Y = 1, A = 1)
r2 = 0.045 #P(C = 0, Y = 1, A = 1)
r3 = 0.105 #P(C = 1, Y = 0, A = 1)
r4 = 0.12 #P(C = 0, Y = 0, A = 1)
r5 = 0.20 #P(C = 1, Y = 1, A = 0)
r6 = 0.025 #P(C = 0, Y = 1, A = 0)
r7 = 0.10 #P(C = 1, Y = 0, A = 0)
r8 = 0.175 #P(C = 0, Y = 0, A = 0)
